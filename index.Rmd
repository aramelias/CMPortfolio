...
**A better visualization, which shows more than just the most "dominant" chroma, is still in the works. I am struggling.**
...
ggplot(NULL, aes(x = seq(1, length(chroma)), y = melody)) +
  geom_point() +
  labs(x = "Beat", y = "Chroma") +
  theme_ayreon()

#ggplot(NULL, aes(x = rep(seq(1, length(chroma)), 12), y = rep(seq(1, 12), length(chroma)))) +
#  geom_tile(fill = chroma) +
#  geom_rug()
