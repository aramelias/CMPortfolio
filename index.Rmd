...
osiris_pitches <-
  ...
  theme_ayreon() +
  labs(title = "Chroma Similarity", subtitle="Isis And Osiris", x = "", y = "")
...
osiris_timbre <-
  ...
  scale_fill_viridis_c(guide = "none") +
  theme_ayreon() +
  labs(title="Timbre Similarity", subtitle="Isis And Osiris", x = "", y = "")
...
breakdown_pitches <-
  ...
  scale_fill_viridis_c(guide = "none") +
  theme_ayreon() +
  labs(title = "Chroma Similarity", subtitle="The Day That...", x = "", y = "")
...
breakdown_timbre <-
  ...
  scale_fill_viridis_c(guide = "none") +
  theme_ayreon() +
  labs(title="Timbre Similarity", subtitle="The Day That...", x = "", y = "")
