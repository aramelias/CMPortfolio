...
### Ayreon's songs have always featured modulations in tempo, but this degree of variation has only increased over time.
...
awareness_tempogram <- get_tidy_audio_analysis("6lJ4zPLT1K1c5BNhY86fjX") %>%
  ...
  labs(title = "The Awareness", x = "Time (s)", y = "Tempo (BPM)") +
  theme_ayreon()
...
osiris_tempogram <- get_tidy_audio_analysis("39VbILtU4hPAb7zDxdiU4z") %>%
  ...
  geom_raster() +
  scale_fill_viridis_c(guide = "none") +
  labs(title = "Isis And Osiris", x = "Time (s)", y = "Tempo (BPM)") +
  theme_ayreon()
...
isolation_tempogram <- get_tidy_audio_analysis("52n7yFo3u09rzhewJLMa54") %>%
  ...
  geom_raster() +
  scale_fill_viridis_c(guide = "none") +
  labs(title = "Day Two: Isolation", x = "Time (s)", y = "Tempo (BPM)") +
  theme_ayreon()
...
shadows_tempogram <- get_tidy_audio_analysis("55Ywj4C9fUHoSqfWIdeBFd") %>%
  ...
  geom_raster() +
  scale_fill_viridis_c(guide = "none") +
  labs(title = "Age Of Shadows/We Are Forever", x = "Time (s)", y = "Tempo (BPM)") +
  theme_ayreon()
...
breakdown_tempogram <- get_tidy_audio_analysis("2bDcXeWeQGULkJEuDpB7wv") %>%
  ...
  geom_raster() +
  scale_fill_viridis_c(guide = "none") +
  labs(title = "The Day That The World Breaks Down", x = "Time (s)", y = "Tempo (BPM)") +
  theme_ayreon()
...
The introductory tracks of Ayreon's albums often give a good representation of what the rest of the album will sound like in terms of mood, tempo and instrumentation. This is because every album follows a storyline, with the singers being characters in said story. The introductory tracks then function as either a prologue or exposition, letting some characters introduce themselves.
