...
**Due to an error in R that keeps me from accessing the data frame despite successfully retrieving the analysis, I have not yet been able to process this track's chroma features.**

```{r include=TRUE, echo=FALSE}
osiris <- get_track_audio_analysis("39VbILtU4hPAb7zDxdiU4z")[6]
osiris
```
