...
This plot is an overview of Ayreon's six albums, in chronological order. The valence and energy are plotted against each other on the axes, while the size of the circle represents loudness and the color represents the mode.
